...
$query=pg_query($connection,"INSERT INTO follower(id_pelamar,id_login) VALUES ($id_teman,$id_kita)");
$query=pg_query($connection,"INSERT INTO follower(id_pelamar,id_login) VALUES ($id_kita,$id_teman)");
