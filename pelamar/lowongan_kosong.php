                    ...
                    ORDER BY id_lowongan desc" );
                            ...
                            while($r = pg_fetch_array($query)){
                              ...
                              if ($tgl_hari_ini<$tanggal_tutup ){
                                       ...
                                       $query_menghitung = pg_query($connection,"SELECT * FROM lamaran_perusahaan 
                                       where id_lowongan = $r[id_lowongan]");
                                       $hitungan = pg_num_rows($query_menghitung);

                                       if($hitungan<$r['max_lamaran']){
                              ...
                              ?>
                                  ...
                                  }else if($tgl_hari_ini>$tanggal_tutup ){
