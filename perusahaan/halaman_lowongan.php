	...
	<fieldset>
		...
		if($id_kita == $_SESSION['id_perusahaan'])
		{
	...
	<div class="col-xs-12">
				...
				<a onclick="return confirm('Are you sure you want to edit this item?');" href=<?php

					echo "home_perusahaan.php?page=edit_lowongan&id=$id&id_kategori=$id_kategori&id_kita=$_SESSION[id_perusahaan]";


				?>><button class="btn btn-warning" type="submit" name="btn_upload" style="float:right; margin:0px 3px 0px 3px;">Edit Lowongan</button></a>	
				

				<a onclick="return confirm('Are you sure you want to delete this item?');" href=<?php 

				echo "perusahaan/php/proses_hapus_lowongan.php?id=$id&id_kategori=$id_kategori&id_kita=$_SESSION[id_perusahaan]";
