...
<div class="col-xs-12">
									...
									<h3 style="color:#f05f40;">Following</h3>
									<hr>
				 ...
				 ?>
							  	...
							  	$query_teman = pg_query($connection,"SELECT id_koneksi,id_pelamar,id_login FROM koneksi_teman
							  	 where id_pelamar=$id_pelamar AND id_login = $lamaran[id_pelamar] ORDER BY id_koneksi desc");
							  	...
							  	?>
			                            ...
			                            <div style="height:240px; margin-bottom:15px; background-color:white; padding:10px 10px 10px 10px;">
			                              ...
			                              <center><a href="<?php echo "home_pelamar.php?page=profil_pelamar&page_profil=profil_kita&id_pelamar_nya=$teman[id_login]" ?>">
							 ...
							 ?>
							 	<?php 
							  	...
							  	$query_teman = pg_query($connection,"SELECT id_follower,id_pelamar,id_login FROM follower
							  	 where id_pelamar=$lamaran[id_pelamar] AND id_login =$id_pelamar  ORDER BY id_follower desc");
