...
<fieldset>
	...
	<form action="perusahaan/php/proses_tambah_berkas.php" method="post" enctype="multipart/form-data">
	...
	<?php
		...
		$query=pg_query($connection,"SELECT * FROM berkas_perusahaan where id_perusahaan = $_SESSION[id_perusahaan]");
 	...
 	<div class="col-md-4 col-xs-12">
		<a href="<?php echo "img/perusahaan/berkas/$r[nama_berkas]" ?>"><embed style="width:100%; height:150px; " src="<?php echo "img/perusahaan/berkas/$r[nama_berkas]" ?>" type="application/pdf"></embed></a>
	     <a href="<?php echo "perusahaan/php/proses_hapus_berkas.php?id_berkas=$r[id_berkas_perusahaan]&id_perusahaan_nya=$_SESSION[id_perusahaan]" ?>"><input type='button' class="btn-link" value='Delete'  style="margin-bottom:10px; float:right;"></a>
