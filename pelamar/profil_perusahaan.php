...
<div >
           ...
           <?php 
           $qlike =pg_query($connection,"SELECT * FROM likes WHERE id_perusahaan=$_GET[id_perusahaan_nya] 
           	AND id_pelamar=$_SESSION[id_pelamar]");

            $qdislike =pg_query($connection,"SELECT * FROM dislikes WHERE id_perusahaan=$_GET[id_perusahaan_nya] 
           	AND id_pelamar=$_SESSION[id_pelamar]");

           $qlike_array=pg_fetch_array($qlike);
           $qdislike_array=pg_fetch_array($qdislike);

           if (!isset($qlike_array['id_pelamar']) AND !isset($qlike_array['id_perusahaan'])
           		AND !isset($qdislike_array['id_pelamar']) AND !isset($qdislike_array['id_perusahaan'])) {
           	
           

           ?>
		 		<a href="<?php echo"pelamar/php/proses_like.php?id_perusahaan_nya=$_GET[id_perusahaan_nya]&id_pelamar=$_SESSION[id_pelamar]";?>"><img src="img/like/like.png" alt="" style="width:39px; height:39px;"></a>
		 		<a href="<?php echo"pelamar/php/proses_dislike.php?id_perusahaan_nya=$_GET[id_perusahaan_nya]&id_pelamar=$_SESSION[id_pelamar]";?>"><img src="img/like/dislike.png" alt="" style="width:33px; height:33px;"></a>
		 		<?php

		 			}else if(isset($qlike_array['id_pelamar']) AND isset($qlike_array['id_perusahaan'])){


		 		?>
		 		<a href="#">
		 		<img src="img/like/like.png" alt="" style="width:39px; height:39px;"></a>
		 		<small> (Anda Menyukai Perusahaan Ini) </small>
		 		<a href="<?php echo"pelamar/php/proses_dislike.php?id_perusahaan_nya=$_GET[id_perusahaan_nya]&id_pelamar=$_SESSION[id_pelamar]";?>">
		 			<img src="img/like/dislike.png" alt="" style="width:33px; height:33px;"></a>
		 		

		 		<?php

		 		}else if(isset($qdislike_array['id_pelamar']) AND isset($qdislike_array['id_perusahaan'])){



		 		?>

		 		<a href="<?php echo"pelamar/php/proses_like.php?id_perusahaan_nya=$_GET[id_perusahaan_nya]&id_pelamar=$_SESSION[id_pelamar]";?>">
		 		<img src="img/like/like.png" alt="" style="width:39px; height:39px;"></a>
		 		<a href="#">
		 			<img src="img/like/dislike.png" alt="" style="width:33px; height:33px;"></a>
		 		
		 		<small> (Anda Tidak Menyukai Perusahaan Ini) </small>
